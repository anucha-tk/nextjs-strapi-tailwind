...
export const FeaturedArticle = async () => {
  const data = await getBlogs({ populate: true });
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <div
                className='flex h-10 items-center gap-spacing-md sm:hidden'
                id='categories'
              >
              ...
              >
                <div
                  className='flex items-start gap-spacing-xl self-stretch'
                  id='heading_and_icon'
                >
              ...
              >
                ...
                >
                  <div
                    className='flex flex-col items-start gap-spacing-md'
                    id='text_and_autor'
                  >
                    <p className='hidden text-sm-semibold sm:block sm:text-white'>
                      Written by
                    </p>
                    <div
                  ...
                  >
                    ...
                    <div className='flex h-[40px] items-center gap-spacing-md py-spacing-md'>
                      <p className='text-md-semibold text-primary sm:block sm:text-white'>
                        {date}
                      </p>
                    </div>
                  </div>
                ...
                >
                  ...
                  <div
                    className='flex h-10 items-center gap-spacing-md'
                    id='categories'
                  >
                    {tags.map((e, i) => (
                      <div
